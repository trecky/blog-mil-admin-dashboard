...
var CreatePostService_1 = __importDefault(require("@modules/posts/services/CreatePostService"));
var PostController = /** @class */ (function () {
    function PostController() {
    }
    PostController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, author_id, date, parsedDate, createpost, post;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, author_id = _a.author_id, date = _a.date;
